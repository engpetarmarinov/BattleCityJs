...
define([
	...
	Crafty.c('Tank', {
		...
		init: function() {
			var tankComponent = this;
			tankComponent.requires('Block, Canvas, Collision, SpriteAnimation, spr_tank1_s2')
					.attr({
		...
		stopOnBots: function() {
			this.onHit('Bot', this.stopMovement);
			return this;
		},
		// Stops the movement
	...
	Crafty.c('Bullet', {
		...
		explodeOnBots: function() {
			this.onHit('Bot', function (bots) {
				if(bots.length > 0){
